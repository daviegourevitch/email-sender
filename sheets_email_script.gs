...
// Marcels function
function submitNewResponses(string){
  var form = FormApp.openByUrl(
    'https://docs.google.com/forms/d/1nMYUm562PXBXwo7rNa9jOGX2scaiQC8QW0dsgF5TG9Y/edit'
   );
  var sheet = SheetApp.openByUrl('https://docs.google.com/spreadsheets/d/1MvBx2cORCNMIZ-VUjnzu7DDu-av_lfJZg_p8kYb4Ayw/edit#gid=1960322623');
...
function __createEmails(response) {
  ...
  var emailChoiceItem0 = emailChoiceStrings[0] == 'A one time email about the Wednesday board game nights';
  var emailChoiceItem1 = emailChoiceStrings[1] == 'A one time email about the intro to D&D event';
  var emailChoiceItem2 = emailChoiceStrings[2] == 'A one time email about the upcoming board game tournament';
  var emailChoiceItem3 = emailChoiceStrings[3] == 'Keep me in the loop about everything!';
  ...
  emailContents += "</body>      <hr>      <footer style='display:inline-block float:left text-align:center'>   <div>Follow us on social media!</div>	<span class='center'><a target='_blank' href='https://discord.gg/MWk2sxA'><img class='external-logo' src='http://prawn.wtf/discord_logo_colour copy.png'></a></span>	<span class='center'><a target='_blank' href='https://www.facebook.com/CUSCGaming/'><img class='external-logo' src='http://prawn.wtf/f_logo_colour.png'></a></span>		   </footer></html>";
...
function __sendEmail(emailObj) {
    ...
    {'subject':'Welcome to CUSC Gaming!'},
...
function testEmailGeneration() {
  ...
  var emailObj = __createEmails(responses[0]);
  
  
  GmailApp.sendEmail(
	'CarletonStrategyClub@gmail.com',
    'CUSC Gaming',
